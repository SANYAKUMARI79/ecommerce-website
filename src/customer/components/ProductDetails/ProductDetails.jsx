...
export default function Example() {
      ...
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            ...
            <h1 className=" text-lg lg:text-xl  text-gray-900 sm:text-3xl opacity-60 pt-1">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
                ...
                <p className="opacity-50 text-sm">56500 Ratings</p>
                <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">3423 Reviews</p>
                </div>
                     ...
                     <Grid item xs={5}>
                      ...
                      <div className="flex items-center space-x-3">
                        <Rating  value={4.6} precision={.5} readOnly/>
                           <p className="opacity-60">33475 Ratings</p>
                      ...
                      <Box className="mt-5 space-y-3">
                        ...
                        <Grid container alignItems="center" gap={2}>
                            ...
                            <Grid item xs={7}>
                             <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4,height:7,color:"yellowgreen"}} variant="determinate" value={20} color="warning"/>
                            </Grid>
                        </Grid>
                        <Grid container alignItems="center" gap={2}>
                            <Grid item xs={2}>
  ...
  <div className="flex flex-wrap space-y-5">
    ...
    {mens_kurta.map((item, index) => (  // Add index parameter
    
      <HomeSectionCard 
        key={item.id || index}  // Now, index is properly defined
        imageUrl={item.image} 
        brand={item.brand} 
        title={item.title} 
      />
